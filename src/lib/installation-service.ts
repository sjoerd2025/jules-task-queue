...
export class InstallationService {
   ...
   * Optimized: Uses bounded concurrent execution to significantly reduce
   * total synchronization time while safely preventing GitHub API secondary rate limits.
   */
